...
public class MultiZoneGenerator : MonoBehaviour
{
    ...
    public static MultiZoneGenerator Instance { get; private set; }
    ...
    void Start()
    {
        ...
        if (player != null)
        {
            ...
            playerSpawnPoint = player.transform.position = spawnWorldPos; // đặt vị trí player vào điểm spawn
        }
